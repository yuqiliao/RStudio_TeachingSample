...
- How to create animated visualizations?
  - Overall steps
    ...
    - more customized approach (`tweenr` + `animation`)
  - Quiz
  - More resources for creating animated visualizations
...
.right-code-scroll35[
```{r gganimate2, message=FALSE, eval=TRUE, echo = TRUE, warning=FALSE, results = "markup", cache = TRUE, out.height= 380}
# Create a gganimate object
anim <- anim +
...
.right-code-scroll35[
```{r gganimate3, message=FALSE, eval=TRUE, echo = TRUE, warning=FALSE, results = "markup", cache = TRUE}
# Create a gganimate object
anim <- anim +
...
```{r gganimate4, message=FALSE, eval=TRUE, echo = TRUE, warning=FALSE, results = "markup", cache = TRUE, out.height= 380}
# View animation
anim
```
]
...
.right-code-scroll35[
```{r gganimate5, message=FALSE, eval=TRUE, echo = TRUE, warning=FALSE, results = "markup", cache = TRUE, out.height= 380}
...
.right-code-scroll35[
```{r gganimate6, message=FALSE, eval=FALSE, echo = TRUE, warning=FALSE, results = "markup", cache = TRUE}
# define output path
...
1. Could the `states` argument be set to other values?
2. Are there other arguments that could be customized?

```{r gganimate7, message=FALSE, eval=FALSE, echo = TRUE, warning=FALSE, results = "markup", cache = TRUE, out.height= 330}
basePlot +
...
---
More resources - GIF compression
========================================================
